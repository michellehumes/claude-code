...
class ExecutiveTabBuilder:
    ...
    def build_weekly_summary_tab(self):
        ...
        dashboard_data = [
            ...
            ['Sleep Score (7d avg)', '=AVERAGE(\'🔴 Oura Sleep Tracker\'!B2:B8)', '', 'Interviews This Week', '=COUNTIFS(\'💼 Interview Tracker\'!C:C,">="&TODAY()-WEEKDAY(TODAY(),2)+1,\'💼 Interview Tracker\'!C:C,"<"&TODAY()-WEEKDAY(TODAY(),2)+8)', '', ''],
            ['Readiness (7d avg)', '=AVERAGE(\'🔴 Oura Readiness Tracker\'!B2:B8)', '', 'Offers Received', '=COUNTIF(\'💼 Job Pipeline\'!H:H,"Offer")', '', ''],
            ['Activity (7d avg)', '=AVERAGE(\'🔴 Oura Activity Tracker\'!B2:B8)', '', 'Top Priority', '=IFERROR(INDEX(\'💼 Job Pipeline\'!C:C,MATCH("P0 - Critical",\'💼 Job Pipeline\'!M:M,0)),"None")', '', ''],
